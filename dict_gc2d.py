...
##
## potential: string; 'KMdCN' for the Kryukov-Martinell-delCastilloNegrete potential, 'turbulent' for the turbulent potential
...
dict_list = [{'potential': potential} for _ in range(len(array))]
