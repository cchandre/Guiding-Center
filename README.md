...
####
- *FLR*: tuple of 2 strings; 'all', 'padé' or 'none'; if 'all', FLR to all orders is taken into account; if 'padé', a Padé approximant is considered for the FLR effects; if 'none', no FLR effects are taken into account 
